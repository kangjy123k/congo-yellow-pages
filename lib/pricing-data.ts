...
export const COMMUNES: CommunePrice[] = [
  {
    ...
    pricePerSqm: 2800,
    center: [-4.305, 15.285],
    bounds: rect(-4.305, 15.285, 0.015, 0.025),
  ...
  },
  {
    ...
    pricePerSqm: 1000,
    center: [-4.355, 15.335],
    bounds: rect(-4.355, 15.335, 0.025, 0.025),
  ...
  { slug: "kinshasa", name: "Kinshasa", pricePerSqm: 900, center: [-4.32, 15.305], bounds: rect(-4.32, 15.305, 0.01, 0.012) },
  { slug: "barumbu", name: "Barumbu", pricePerSqm: 700, center: [-4.32, 15.315], bounds: rect(-4.32, 15.315, 0.008, 0.01) },
  { slug: "lingwala", name: "Lingwala", pricePerSqm: 800, center: [-4.33, 15.3], bounds: rect(-4.33, 15.3, 0.008, 0.01) },
  { slug: "kintambo", name: "Kintambo", pricePerSqm: 1300, center: [-4.315, 15.265], bounds: rect(-4.315, 15.265, 0.01, 0.015) },
  { slug: "bandalungwa", name: "Bandalungwa", pricePerSqm: 900, center: [-4.335, 15.285], bounds: rect(-4.335, 15.285, 0.008, 0.012) },
  { slug: "kasa-vubu", name: "Kasa-Vubu", pricePerSqm: 750, center: [-4.345, 15.295], bounds: rect(-4.345, 15.295, 0.008, 0.012) },
  { slug: "kalamu", name: "Kalamu", pricePerSqm: 700, center: [-4.355, 15.305], bounds: rect(-4.355, 15.305, 0.01, 0.012) },
